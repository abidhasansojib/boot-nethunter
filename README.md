...
# Installation 
   ...
   ```bash
   pkg install git && git clone https://github.com/abidhasansojib/Nethunter_Chroot_Termux.git && cd Nethunter_Chroot_Termux && chmod +x install_boot-kali.sh && ./install_boot-kali.sh
   ```
